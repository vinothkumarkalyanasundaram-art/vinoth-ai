        ...
        <div className="items-center space-y-2 xl:flex flex-row xl:gap-x-8 xl:space-y-0">
          <div className="flex flex-col items-center pt-8">
            ...
            <div className="flex space-x-5 pt-6">
              ...
              <Link
                href={
                  "https://www.linkedin.com/in/vinoth-kumar-kalyanasundaram-a6399b1b/"
                }
                target="_blank"
              >
                <svg
            ...
            <div className="w-full">
              ...
              <form onSubmit={handleSubmit}>
                <input
                  ...
                  value={query}
                  type="text"
                  placeholder="How can help you? Enter a keyword to search"
                ...
                <button
                  type="submit"
                  className="w-full bg-[#14b8a6] my-2 border-[1px] border-blue-900 py-2 px-4"
